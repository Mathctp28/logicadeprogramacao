...
if (isNaN(nota1) || isNaN(nota2) || isNaN(nota3)){
   ...
   resultado.innerHTML("Por favor, insira notas maiores que 0")
    ...
    if (media > 7){
        resultado.innerHTML = 'media ${media} - Situação Aprovado'
    }
    else if (media > 5){
        resultado.innerHTML = 'media ${media} - Situação Recuperação'
    }
    else {
        resultado.innerHTML = 'media ${media} - Situação Reprovado'
    }
